...
public:
  ...
  SUTILAPI static std::string getVarFileName();
  SUTILAPI static std::string getSceneFileName();
  SUTILAPI static void refreshScreen();
  SUTILAPI static void setCameraData(float fovx,float fovy);
  SUTILAPI static void setCameraData(double xPos,double yPos, double zPos);
  SUTILAPI static void setCameraData(double xPosition,double yPosition, double zPosition,double xRotation,double yRotation,double zRotation, double wRotation);
private:
