...
void SampleScene::updateTexture(){
}
void SampleScene::publishResult(){
}
void SampleScene::getFramePixels(){
}
void SampleScene::renderCross(){
}

void SampleScene::SetCameraData(){

}
void SampleScene::updateROS(){
}
